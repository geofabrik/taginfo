...
#------------------------------------------------------------------------------
#
#  Copyright (C) 2010-2026  Jochen Topf <jochen@topf.org>
#
...
ALL_SECTIONS = %w[download taginfo].freeze
SECTIONS = TAGINFO_CONFIG.get('instance.sections', ALL_SECTIONS).to_h{ |s| [s.to_sym, s] }
